namespace SurveyConfiguratorApp.Forms.Questions
{
    partial class FormSliderQuestion
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.panelContainer.Controls.Add(this.textBoxCaptionMax);
            this.panelContainer.Controls.Add(this.textBoxCaptionMin);
            this.panelContainer.Controls.Add(this.customLabelControlTitleCaption);
            this.panelContainer.Controls.Add(this.customLabelControlMax);
            this.panelContainer.Controls.Add(this.customLabelControlMin);
